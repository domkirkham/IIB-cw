function [x,status,history] = l1_ls_exact(A,varargin)
%
...
% IPM PARAMETERS
MU              = 3;        % updating parameter of t
MAX_NT_ITER     = 3000;      % maximum IPM (Newton) iteration

% LINE SEARCH PARAMETERS
ALPHA           = 0.5;     % minimum fraction of decrease in the objective
BETA            = 0.9;      % stepsize decrease factor
MAX_LS_ITER     = 800;      % maximum backtracking line search iteration
